...
#ElseIf OFFICE_APP = "POWERPOINT" Then
    Call ActivePresentation.FollowHyperlink(Address:="https://github.com/koichiro-git/extools/releases")
#End If
End Sub
...
#ElseIf OFFICE_APP = "POWERPOINT" Then
    Call ActivePresentation.FollowHyperlink(Address:="https://koichiro-git.github.io/extools/")
#End If
End Sub
